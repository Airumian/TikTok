...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        discoverButton.setImage(UIImage(named: "Discover"), for: .normal)
        let shapeButton = UIButton()
        shapeButton.setImage(UIImage(named: "Button Shape"), for: .normal)
        let inboxButton = UIButton()
        inboxButton.setImage(UIImage(named: "Inbox"), for: .normal)
        let meButton = UIButton()
        meButton.setImage(UIImage(named: "Me"), for: .normal)
